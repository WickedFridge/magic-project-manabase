...
export default function HelpText() {
    ...
    return (
        <div className={classes.root}>
            ...
            <p className={classes.answer}>Export your decklist (from MTGA, Mtggoldfish, etc...) then paste your decklist and press Submit.</p>
            <p className={classes.question}>What do the numbers mean ?</p>
            <p className={classes.answer}>P2 numbers are conditional probabilities of being able to cast your spell assuming you have enough lands. For example, if you wanna play a Jace, the mind's Sculptor, it will get every combination of 4 lands your deck can produce and calculate the ratio of them that can play the spell.</p>
            <p className={classes.answer}>P1 numbers are P2 numbers multiplied by the probability of hitting your Nth land by turn K (with K=N+7).</p>
            <p className={classes.answer}>The Lands numbers represent the ability of each land to play a spell on curve.</p>
            <p className={classes.question}>How am I supposed to use Project Manabase ?</p>
            <p className={classes.answer}>Look at the numbers, cut the worst lands and hardest spells to cast, and iterate until your manabase looks good enough. Ask more of your manabase !</p>
            <p className={classes.question}>Why are the numbers strange for my deck ?</p>
            <p className={classes.answer}>It won't work well on a decklist that doesn't have an accurate amount of lands, but will work on decks of any length.</p>
            <p className={classes.answer}>In addition, Project Manabase only evaluates lands so far, so mana dorks and Cantrips won't count towards your numbers.</p>
